...
## Table of contents
- [Types](#types)
- [Values](#function-vs-block-scope)
- [Natives](#hoisting)
- [Coercion](#scope-closures)
- [Grammar](#college-notes)
...
Objects and arrays will first be converted to their primitive
Value and the result value will be coerced to number (if it is not already a number). 
...
Var a = {} = object
{} = just a regular code block (it’s valid, but not very idiomatic) 
...
Why ? > Otherwise the program will fail, not very forgiving; 
